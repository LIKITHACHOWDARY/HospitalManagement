...
@WebServlet("/stafffetchallpatients")
public class StaffFetchallPatients extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		if (req.getSession().getAttribute("staff") != null) {
			...
			if (list.isEmpty()) {
				...
				req.getRequestDispatcher("ViewPatientInStaff.jsp").forward(req, resp);
			}
		} else {
